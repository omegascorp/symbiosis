    ...
    function normalizeOptions(options) {
        switch (typeof options) {
            ...
            case "object" :
                ...
                options.onscroll = ("scroll" in options) ? options.onscroll : function(){};
                return options;
            default :
    ...
    function Scrollar (options) {
        ...
        (function () {
            ...
            function init () {
                ...
                options.hEnd=options.element.find('.scrollar-systemscrolls').scrollLeft()+options.element.find('.scrollar-systemscrolls').width()==options.element.find('.scrollar-contentwrap').width();
                options.hStart=options.element.find('.scrollar-systemscrolls').scrollLeft()==0;
                options.vEnd=options.element.find('.scrollar-systemscrolls').scrollTop()+options.element.find('.scrollar-systemscrolls').height()==options.element.find('.scrollar-contentwrap').height();
                options.vStart=options.element.find('.scrollar-systemscrolls').scrollTop()==0;
                
                $.proxy(options.onscroll(), options);
            }
